  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center">
      ...
      <main className="flex-grow flex flex-col items-center justify-center gap-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full max-w-5xl px-4">
          <div className="bg-white shadow-lg rounded-lg p-6 text-center hover:shadow-2xl transition-shadow">
            <h3 className="text-xl font-semibold text-gray-700 mb-4">Weather</h3>
            <p className="text-gray-500 mb-6">
              A weather app that displays weather information.
            </p>
            <Link href="/weather" className="inline-block bg-blue-500 text-white py-2 px-4 rounded-full hover:bg-blue-600 transition-colors">
              Try Weather
            </Link>
          </div>
        </div>
